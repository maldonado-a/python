El script en Python automatiza la actualización de un formulario web y la simulación de envío de correos electrónicos basado en datos de un archivo Excel.
